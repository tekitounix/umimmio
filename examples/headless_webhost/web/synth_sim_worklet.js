...
class SynthWorkletProcessor extends AudioWorkletProcessor {
    ...
    async initWasm(wasmBytes) {
        try {
            ...
            // Initialize Emscripten runtime (d = __wasm_call_ctors)
            // This is CRITICAL - must be called before any other exports
            const wasmCallCtors = exports.d;
            if (wasmCallCtors) {
                console.log('[SynthWorklet] Calling __wasm_call_ctors (exports.d)...');
                wasmCallCtors();
                console.log('[SynthWorklet] Emscripten runtime initialized');
            } else {
                console.warn('[SynthWorklet] __wasm_call_ctors not found!');
            }
