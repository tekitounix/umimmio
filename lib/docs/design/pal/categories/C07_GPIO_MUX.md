...
| 定義 | レジスタ/データ | カテゴリ |
|------|--------------|---------|
| ピンモード設定 | GPIOx_MODER | C6 (ペリフェラルレジスタ) |
| AF 番号設定 | GPIOx_AFRL / GPIOx_AFRH | C6 (ペリフェラルレジスタ) |
| ピン-AF-信号マッピング | データシート AF テーブル | **C7 (本カテゴリ)** |
| 電気特性設定 | GPIOx_OTYPER / OSPEEDR / PUPDR | C6 (ペリフェラルレジスタ) |
