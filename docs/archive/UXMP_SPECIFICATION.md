...
**移行メモ:** 本仕様は UMI-SysEx へ統合完了。本書は参考資料。
全体概要は「docs/new/umi-sysex/UMI_SYSEX_OVERVIEW.md」、
SysExトランスポート共通規約は「docs/new/umi-sysex/UMI_SYSEX_TRANSPORT.md」。
...
**移行メモ:** UMI-DATA に統合中。
仕様本体は [docs/new/umi-sysex/UMI_SYSEX_DATA.md](docs/new/umi-sysex/UMI_SYSEX_DATA.md) と
[docs/new/umi-sysex/UMI_SYSEX_DATA_SPEC.md](docs/new/umi-sysex/UMI_SYSEX_DATA_SPEC.md) を参照。
