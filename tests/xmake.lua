...
target("test_umimmio")
    ...
    add_tests("default")
    set_default(true)
    add_files("test_main.cc", "test_register_field.cc", "test_transport.cc", "test_access_policy.cc", "test_byte_transport.cc")
...
target("test_umimmio_compile_fail")
    set_kind("phony")
    set_default(false)
    add_tests("write_ro", "read_wo", "value_typesafe", "modify_w1c", "value_signed", "write_ro_value", "flip_w1c", "field_overflow", "read_field_eq_int", "modify_wo", "flip_ro", "flip_wo", "clear_non_w1c", "cross_register_write", "write_zero_args", "transport_tag_mismatch", "modify_cross_register", "flip_multi_bit", "get_wrong_field")
    ...
    on_test(function()
        ...
        local test_cases = {"write_ro", "read_wo", "value_typesafe", "modify_w1c", "value_signed", "write_ro_value", "flip_w1c", "field_overflow", "read_field_eq_int", "modify_wo", "flip_ro", "flip_wo", "clear_non_w1c", "cross_register_write", "write_zero_args", "transport_tag_mismatch", "modify_cross_register", "flip_multi_bit", "get_wrong_field"}
